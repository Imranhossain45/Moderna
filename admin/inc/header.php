...
if (!isset($_SESSION['login-user'])) {
    header('locatio: <?=siteUrl()?>/auth/login.php');
}
function siteUrl()
{
                                            ...
                                            <div class="dropdown-item d-flex">
                                                <div class="mr-3">
                                                    <div class="avatar avatar-sm" style="width: 32px; height: 32px;">
                                                        <img src="../images/300 (APPLY).jpg" alt="Avatar" class="avatar-img rounded-circle">
                                                    </div>
                                                </div>
                                                <div class="flex">
                                                    <a href="">Imran Hossain</a> left a comment on <a href="">FlowDash</a><br>
                            ...
                            <li class="nav-item dropdown">
                                <a href="#account_menu" class="nav-link dropdown-toggle" data-toggle="dropdown" data-caret="false">
                                    <span class="mr-1 d-flex-inline">
                                        <span class="text-light">Imran Hossain</span>
                                    </span>
                                    <img src="assets/images/avatar/demi.png" class="rounded-circle" width="32" alt="Frontted">
                                </a>
                                <div id="account_menu" class="dropdown-menu dropdown-menu-right">
                                    <div class="dropdown-item-text dropdown-item-text--lh">
                                        <div><strong>Imran Hossain</strong></div>
                                        <div class="text-muted">@imranhossain</div>
                                    </div>
